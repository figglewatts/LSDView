...
namespace LSDView.util
{
	public static class LibLSDUtil
	{
		...
		public static List<Mesh> CreateLBDTileMesh(LBDTile tile, LBDTile[] extraTiles, int x, int y, TMD tilesTmd, Shader shader, Texture2D vram)
		{
		...
		private static Mesh createSingleLBDTileMesh(LBDTile tile, int x, int y, TMD tilesTmd, Shader shader, Texture2D vram)
		{
			...
			switch (tile.TileDirection)
			{
				...
				{
					tileMesh.Transform.Rotation = Quaternion.FromAxisAngle(Vector3.UnitY, MathHelper.DegreesToRadians(90));
					break;
				}
				case LBDTile.TileDirections.Deg180:
				{
					tileMesh.Transform.Rotation = Quaternion.FromAxisAngle(Vector3.UnitY, MathHelper.DegreesToRadians(180));
					break;
				}
				case LBDTile.TileDirections.Deg270:
				{
					tileMesh.Transform.Rotation = Quaternion.FromAxisAngle(Vector3.UnitY, MathHelper.DegreesToRadians(270));
					break;
				}
			}
